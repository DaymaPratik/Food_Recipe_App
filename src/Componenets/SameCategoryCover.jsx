...
function SameCategoryCover({categoryType}) {
  ...
  return (
    <section className='min-h-[70vh] h-fit md:min-h-screen flex flex-col justify-center items-center relative w-full box-border top-0 bg-fixed
    bg-[url("https://images.pexels.com/photos/6400025/pexels-photo-6400025.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2")]
    bg-cover bg-center bg-no-repeat '>
       <section className='absolute h-full flex flex-col  justify-center items-center 
      w-full bg-[#e2606066] '>
        <h3 className='text-[20px] sm:text-[25px] md:text-[30px] text-center lg:text-[35px] font-semibold py-3 '> Looking for a Meal in <span className="">{categoryType}</span> Category?</h3>
        <h5 className='text-[17px] text-center sm:text-[20px] md:text-[25px] lg:text-[30px] font-semibold py-3 '> Find delicious meals tailored for {categoryType} lovers!</h5>
...
export default SameCategoryCover