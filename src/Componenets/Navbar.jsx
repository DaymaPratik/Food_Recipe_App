...
function Navbar() {
  const {showSideBarFunction,setNotValidInput}=useContext(LikedRecipesContext);
  ...
  return (
    <nav className=' py-2 px-5 lg:px-10 flex justify-between items-center z-130 fixed bg-[#100f0fc4] w-full box-border'>
        <Link to={'/'}>
        <motion.img src="https://png.pngtree.com/png-vector/20230224/ourmid/pngtree-kitchen-logo-png-image_6615814.png" alt="" className='w-[60px] md:hidden transition ease-in-out duration-100 rounded-[5px] 
        ...
        <motion.div className='md:hidden text-[40px] text-[#20d6fa] cursor-pointer transition ease-in-out duration-100 rounded-[5px] 
        ...
        lg:text-[18px]'>
            ...
            <motion.button 
         whileTap={{ scale: 1.5 }}
            className='bg-blue-600 rounded-[5px] cursor-pointer hover:bg-blue-800 transition ease-in duration-150 text-white font-semibold px-5 py-2 '>
              Liked Recipes</motion.button>
            </Link>
            <Link to={'/'} className='mx-1 lg:mx-3'>
            <motion.button 
          whileTap={{ scale: 1.5 }}
  
            className='bg-blue-600 rounded-[5px] hover:bg-blue-800 cursor-pointer transition ease-in duration-150 text-white font-semibold px-5 py-2  '>
              Home</motion.button>
            </Link>
           ...
           <motion.button  
           whileTap={{ scale: 1.5 }}
           className='bg-blue-600 hover:bg-blue-800 transition ease-in cursor-pointer duration-150 px-3 py-2 text-white rounded-r-[5px]
            border-none'
